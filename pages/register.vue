<template>
  <div
    class="bg-odd-bg mx-auto w-full md:w-1/2 flex items-center justify-center"
  >
    <div class="w-460px px-4 text-black">
      ...
      <p
        class="text-sm text-black text-opacity-60 text-center w-327px mx-auto mt-2"
      >
      ...
      >
        ...
        <p class="text-center mt-8 md:mt-16 mb-8">
          Bạn đã có tài khoản?
